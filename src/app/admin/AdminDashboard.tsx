...
const AdminDashboard = () => {
  ...
  if (doctorsLoading || appointmentsLoading) return <LoadingPage />;
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Manage your platform, monitor activities, and oversee users all
              </p>
            </div>
          </div>
          <div className="hidden lg:block">
            <div className="w-32 h-32 bg-gradient-to-br from-primary/20 to-primary/5 rounded-full flex items-center justify-center border border-primary/20">
