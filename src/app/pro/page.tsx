    ...
    <div className='max-w-7xl mx-auto px-6 py-8 pt-24'>
          ...
          <div className='flex items-center justify-between bg-gradient-to-br from-primary/10 to-background rounded-3xl p-8 border border-primary/20 '>
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-muted-foreground'>Get unlimited AI consultations, advanced features, and priority support to take
                  your dental health to the next level.</p>
              </div>
            </div>
        ...
        <div className='space-y-8'>
          <div className='text-center space-y-4'>
            ...
            <p className='text-muted-foreground max-w-2xl mx-auto'>Select the perfect plan for your dental care needs. All plans include secure access
              and bank-level encryption.</p>
          </div>
          <PricingTable/>
        </div>
    </div>
