...
const HowItWorks = () => {
  return (
    <section id="howItWorks" className="relative py-32 px-6 outline-hidden z-10 max-w-auto">
      {/* HEADER */}
      <div className="text-center mb-20">
        <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6  ">
